 ...
 *         configurations
 *      2. The default plugin file name is DoubleX RMMV Skill Hotkeys v101b
...
DoubleX_RMMV["Skill Hotkeys"] = "v1.01b";

// The plugin file name must be the same as DoubleX_RMMV.Skill_Hotkeys_File
DoubleX_RMMV.Skill_Hotkeys_File = "DoubleX RMMV Skill Hotkeys v101b";
//
...
(function(SH) {
    ...
    var _WSL = SH.Window_SkillList.orig, $$ = Window_SkillList.prototype;
    var _WBS = SH.Window_BattleSkill.orig;
    ...
    if ($.isCurrentItemEnabled) {
        _WBS.isCurrentItemEnabled = $.isCurrentItemEnabled;
        $.isCurrentItemEnabled = function() { // New
            // Added to prevent unusable hotkey skills from being selected
            if (!_WSL.isCurrentItemEnabled.call(this)) return false;
            //
            return _WBS.isCurrentItemEnabled.apply(this, arguments);
        }; // $.processHandling
    } else {
        /**
         * Nullipotent
